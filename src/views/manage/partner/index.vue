...
<div class="app-container">
  ...
  <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
    ...
    <el-table-column label="合作商名称" align="center" prop="nodeCount" />
  ...
  <el-dialog title="合作商详情" v-model="partnerInfoOpen" width="500px" append-to-body>
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="联系电话">{{ form.contactNumber }}</el-descriptions-item>
      <el-descriptions-item label="分成比例">{{ form.commissionRate }}%</el-descriptions-item>
    </el-descriptions>
  </el-dialog>
</div>
</template>
...
function resetPwd(row) {
  const _id = row.id;
  proxy.$modal.confirm('确定要重置该合作商的密码吗？').then(function () {

...
<div class="app-container">
  ...
  <el-dialog :title="title" v-model="open" width="500px" append-to-body>
    <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="策略方案" prop="discount">
        <el-input-number :min="1" :max="100" :precision="0" v-model="form.discount" placeholder="请选择"></el-input-number>
      </el-form-item>
    </el-form>
    <template #footer>
  ...
  <!-- 查看详情对话框 -->
  <el-dialog title="查看详情" v-model="policyOpen" width="500px" append-to-body>
    <el-form-item label="策略名称" prop="policyName">
